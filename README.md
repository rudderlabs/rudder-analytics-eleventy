...
This repository contains a sample Eleventy web app which can be integrated with RudderStack's [JavaScript SDK](https://github.com/rudderlabs/rudder-sdk-js) through CDN.
